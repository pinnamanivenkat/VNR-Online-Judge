...
var compile_file_1 = require("./compile-file");
...
function runJavaFile(filePath) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, helper_1.multipleArgsCallbackifier.apply(void 0, [filePath, runJavaFileAndReturnPromise].concat(args))];
        });
    });
}
exports.runJavaFile = runJavaFile;
function runJavaFileAndReturnPromise(filePath, options) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, compile_file_1.compileJavaFile(filePath, options)];
                case 1:
...
exports.runJavaFileAndReturnPromise = runJavaFileAndReturnPromise;
